     ...
     */
	 function options_page() { ?>
		...
		<div id="optionsframework-wrap" class="wrap">
		    ...
		    <div id="optionsframework-metabox" class="metabox-holder">
			    <div id="optionsframework" class="postbox">
					...
					<div id="optionsframework-submit">
						...
						<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( '恢复默认设置', 'theme-textdomain' ); ?>" onclick="return confirm( '<?php print esc_js( __( '警告：点击确定，之前所有设置修改都将丢失！', 'theme-textdomain' ) ); ?>' );" />
						<div class="clear"></div>
					</div>
					</form>
				</div> <!-- / #container -->
			...
			<div class="options-caid"><span class="dashicons dashicons-excerpt-view" title="打开分类ID对照"></span></div>
			<div class="catid-list"><?php show_id();?></div>
		</div> <!-- / .wrap -->
